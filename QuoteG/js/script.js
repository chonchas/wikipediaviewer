$(document).ready(function(){
	...
	var quote =  $("#quote");
	var autor = $("#autor")
	var bgcolors = ["MediumBlue", "SeaGreen ","Tomato ","Cyan","Linen","green","coral","Chartreuse","CadetBlue","Chocolate","DarkSlateGray","DarkOliveGreen ","DarkGreen","DarkRed","DarkGray","DarkGoldenRod","DeepSkyBlue"];
	var i = 0;
